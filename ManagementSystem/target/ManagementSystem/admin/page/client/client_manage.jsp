...
<form class="layui-form layui-form-pane" style="margin-bottom: 3px; "  >
  <div class="layui-form-item" style="margin-bottom: 1px; min-width:1051px;">
    ...
    <div class="layui-input-inline" style="  width: 150px; margin-right: -1px;">
      <input class="layui-input" id="q" onkeydown="if(event.keyCode==13) reload_data()"  ">
    </div>
...
<div class="layui-btn-group">
	...
	<a class="layui-btn layui-btn-xs  layui-btn-warm" lay-event="deposit">充值</a>
	<a class="layui-btn layui-btn-xs  layui-btn-warm" lay-event="consumption">消费</a>
	<a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="bill">查看帐单</a>
</div>
</script>
			...
			, element = layui.element; //元素操作
			  ...
			  table.render({
			   ...
			   cols: [[
			      ...
			      ,{field:'address', title: '地址', width:200,style:'font-size: 7px;'}
